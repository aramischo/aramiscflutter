...
import 'package:aramisc/domain/core/model/admin/admin_fees_model/admin_fees_invoice_list_response_model.dart';
...
class AdminFeesInvoiceListController extends GetxController {
  ...
  Future<AdminFeesInvoiceListResponseModel> getFeesInvoiceList() async {
    try {
      ...
      final response = await BaseClient().getData(
          url: AramiscApi.getAdminFeesInvoiceList, header: GlobalVariable.header);
  ...
  Future<AdminFeesInvoiceListResponseModel> searchFeesInvoice(
    ...
    try {
      ...
      final response = await BaseClient().getData(
          url: AramiscApi.searchAdminFeesInvoice(
