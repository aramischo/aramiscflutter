...
import 'package:aramisc/domain/core/model/admin/admin_library_model/member_model/admin_library_add_member_class_response_model.dart';
import 'package:aramisc/domain/core/model/admin/admin_library_model/member_model/admin_library_add_member_parents_response_model.dart';
import 'package:aramisc/domain/core/model/admin/admin_library_model/member_model/admin_library_add_member_roles_response_model.dart';
import 'package:aramisc/domain/core/model/admin/admin_library_model/member_model/admin_library_add_member_section_response_model.dart';
import 'package:aramisc/domain/core/model/admin/admin_library_model/member_model/admin_library_add_member_student_response_model.dart';
import 'package:aramisc/domain/core/model/admin/admin_library_model/member_model/admin_library_add_member_user_name_response_model.dart';
...
class AdminAddMemberController extends GetxController {
  ...
  Future<AdminLibraryAddMemberRolesResponseModel> getRolesList() async {
    try {
      ...
      final response = await BaseClient().getData(
          url: AramiscApi.getAdminMemberRolesList, header: GlobalVariable.header);
  ...
  Future<AdminLibraryAddMemberUserNameResponseModel> getUserNameList(
    ...
    try {
      ...
      final response = await BaseClient().getData(
          url: AramiscApi.getAdminMemberUserNameList(roleId: roleId),
  ...
  Future<AdminLibraryAddMemberClassResponseModel> getClassList(
    ...
    try {
      ...
      final response = await BaseClient().getData(
          url: AramiscApi.getAdminMemberClassList(roleId: roleId),
          header: GlobalVariable.header);
  ...
  Future<AdminLibraryAddMemberSectionResponseModel> getSectionList(
    ...
    try {
      ...
      final response = await BaseClient().getData(
          url: AramiscApi.getAdminMemberSectionList(classId: classId),
          header: GlobalVariable.header);
  ...
  Future<AdminLibraryAddMemberStudentResponseModel> getStudentList(
    ...
    try {
      ...
      final response = await BaseClient().getData(
          url: AramiscApi.getAdminMemberStudentList(
  ...
  Future<AdminLibraryAddMemberParentsResponseModel> getParentsList(
    ...
    try {
      ...
      final response = await BaseClient().getData(
          url: AramiscApi.getAdminMemberParentList(
              classId: classId, sectionId: sectionId),
          header: GlobalVariable.header);
  ...
  Future<PostRequestResponseModel> adminAddMember() async {
    try {
      ...
      final response = await BaseClient().postData(
          url: AramiscApi.postAdminLibraryAddMember,
          header: GlobalVariable.header,
          payload: {
