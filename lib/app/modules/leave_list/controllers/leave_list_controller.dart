...
import 'package:aramisc/domain/core/model/remaining_leave_response_model/remaining_leave_response_model.dart';
...
class LeaveListController extends GetxController {
    ...
    try {
      ...
      final response = await BaseClient().getData(
        url: globalRxVariableController.roleId.value == 4
            ? AramiscApi.getTeacherLeaveList
            : AramiscApi.getStudentLeaveList(studentId),
  ...
  Future<RemainingLeaveResponseModel?> getRemainingLeave(
    ...
    try {
      ...
      final response = await BaseClient().getData(
        url: AramiscApi.getStudentRemainingLeave(studentId),
        header: GlobalVariable.header,
      );
