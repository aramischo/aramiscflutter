...
import 'package:aramisc/app/utilities/widgets/content_tile/content_tile.dart';
...
import 'package:aramisc/app/utilities/widgets/permission_check/permission_check.dart';
                          ...
                          itemBuilder: (context, int index) {
                            return Padding(
                              ...
                              child: ContentTile(
                                ...
                                onTap: () async {
                                  await PermissionCheck().checkPermissions(context);
                                  Get.dialog(
                                    CustomPopupDialogue(
                                      onYesTap: () {
