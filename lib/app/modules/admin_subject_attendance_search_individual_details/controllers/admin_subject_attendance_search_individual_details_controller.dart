...
import 'package:aramisc/app/modules/student_search_attendance/views/widget/display_dot.dart';
...
import 'package:aramisc/domain/core/model/admin/admin_attendance_model/admin_atten_sub_search_individual_details_response_model.dart';
...
class AdminSubjectAttendanceSearchIndividualDetailsController
    ...
    try {
      ...
      final response = await BaseClient().getData(
        url: globalRxVariableController.roleId.value == 1
            ? AramiscApi.getAdminSubAttenSearchDetailsList(
                recordId: recordId,
                subjectNameId: subjectNameId,
              )
            : AramiscApi.getTeacherSubAttenSearchDetailsList(
                recordId: recordId,
                subjectNameId: subjectNameId,
              ),
  ...
  Future<AdminAttenSubSearchIndividualDetailsResponseModel?>
    ...
    try {
      ...
      final response = await BaseClient().getData(
        url: globalRxVariableController.roleId.value == 1
            ? AramiscApi.getAdminSubAttenSearchDetailsWithDateList(
                recordId: recordId,
                subjectNameId: subjectNameId,
                month: month,
                year: year)
            : AramiscApi.getTeacherSubAttenSearchDetailsWithDateList(
                recordId: recordId,
                subjectNameId: subjectNameId,
                month: month,
                year: year),
