...
import 'package:aramisc/app/utilities/widgets/common_widgets/alert_dialog.dart';
...
import 'package:aramisc/domain/core/model/admin/admin_content_model/admin_content_list_response_model.dart';
    ...
    try {
      ...
      final response = await BaseClient().getData(
          url: globalRxVariableController.roleId.value == 1
              ? AramiscApi.getAdminContentList
              : AramiscApi.getTeacherContentList,
  ...
  Future<PostRequestResponseModel> deleteContent(
    ...
    try {
      ...
      final response = await BaseClient().postData(
          url: globalRxVariableController.roleId.value == 1
              ? AramiscApi.adminContentDelete(contentId: contentId)
              : AramiscApi.teacherContentDelete(contentId: contentId),
          header: GlobalVariable.header);
