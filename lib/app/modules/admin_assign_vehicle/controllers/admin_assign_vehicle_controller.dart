...
import 'package:aramisc/domain/core/model/admin/admin_transport_model/admin_assign_vehicle_and_route_response_model.dart';
  ...
  Future<AdminAssignVehicleAndRouteResponseModel>
    ...
    try {
      ...
      final response = await BaseClient().getData(
          url: AramiscApi.getAdminVehicleAssignRouteAndVehicleList,
  ...
  Future<void> addAssignVehicleToRoute(
    ...
    try {
      ...
      final response = await BaseClient().postData(
          url: AramiscApi.postAdminVehicleAssignRouteAndVehicle,
          header: GlobalVariable.header,
          payload: {
            'route': routeId,
            'vehicles': vehicleId,
