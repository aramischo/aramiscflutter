...
import 'package:aramisc/domain/core/model/student/student_library_model/student_isssued_book_list_response_model.dart';
  ...
  Future<StudentIssuedBookListResponseModel> getIssuedBookList(
    ...
    try {
      ...
      final response = await BaseClient().getData(
          url: AramiscApi.getStudentIssuedBookList(studentId: studentId),
