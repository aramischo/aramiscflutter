...
import 'package:aramisc/app/data/constants/image_path.dart';
import 'package:aramisc/app/modules/chat/controllers/chat_controller.dart';
import 'package:aramisc/app/modules/chat_search/controllers/chat_search_controller.dart';
import 'package:aramisc/app/modules/chat_search/views/widget/suggested_search_tile.dart';
import 'package:aramisc/app/utilities/api_urls.dart';
import 'package:aramisc/app/utilities/app_functions/helper_functions.dart';
...
import 'package:aramisc/config/global_variable/chat/pusher_controller.dart';
...
import 'package:aramisc/domain/core/model/chat/file_list_response_model/file_list_response_model.dart';
import 'package:aramisc/domain/core/model/chat/group_chat_list_response_model/group_chat_list_response_model.dart';
import 'package:aramisc/domain/core/model/chat/group_chat_member_list_response_model/group_chat_member_list_response_model.dart';
...
class GroupChatController extends GetxController {
  ...
  void pickFile() async {
    ...
    if (tempFile != null) {
      groupChatPickImage.value = File(tempFile.path);
    } else {
  ...
  Future<GroupChatMemberListResponseModel?> getGroupChatMemberList(
    ...
    try {
      ...
      final response = await BaseClient().getData(
        url: AramiscApi.getGroupChatMemberList(groupId: groupId),
  ...
  Future<GroupChatListResponseModel?> getGroupChatList(
    ...
    try {
      ...
      final response = await BaseClient().getData(
        url: AramiscApi.getGroupChatList(groupId: groupId),
        header: GlobalVariable.header,
      );
  ...
  Future<void> groupLeaveMember({required String groupId}) async {
    try {
      addMemberLoader.value = true;
      final response = await BaseClient().postData(
          url: AramiscApi.groupLeaveMember(groupId: groupId),
          header: GlobalVariable.header);
      PostRequestResponseModel postRequestResponseModel =
          PostRequestResponseModel.fromJson(response);
  ...
  Future<void> groupDelete({required String groupId}) async {
    try {
      addMemberLoader.value = true;
      final response = await BaseClient().postData(
          url: AramiscApi.groupDelete(groupId: groupId),
          header: GlobalVariable.header);
      PostRequestResponseModel postRequestResponseModel =
          PostRequestResponseModel.fromJson(response);
  ...
  Future<GroupChatListResponseModel> groupChatSend() async {
    try {
      ...
      final request =
          http.MultipartRequest('POST', Uri.parse(AramiscApi.sendGroupChat));
  ...
  Future<void> deleteSingleChat(
    ...
    try {
      ...
      final response = await BaseClient().postData(
          url: AramiscApi.groupDeleteSingleChat(threadId: threadId),
          header: GlobalVariable.header);
      PostRequestResponseModel postRequestResponseModel =
          PostRequestResponseModel.fromJson(response);
  ...
  Future<void> forwardSingleChat({
    ...
    try {
      ...
      final response = await BaseClient().postData(
          url: AramiscApi.forwardGroupChat,
          payload: {
            "group_id": groupId,
  ...
  Future<void> removeSingleMemberFromGroup(
    ...
    try {
      ...
      final response = await BaseClient().postData(
          url:
              "${AramiscApi.baseApi}admin-group-member-delete?group_id=$groupId&user_id=$userId",
          header: GlobalVariable.header);
      PostRequestResponseModel postRequestResponseModel =
          PostRequestResponseModel.fromJson(response);
  ...
  Future<FileListResponseModel> getGroupChatFileList(
    ...
    try {
      ...
      final response = await BaseClient().getData(
        url: AramiscApi.getGroupChatFileList(groupId: groupId),
        header: GlobalVariable.header,
      );
