...
import 'package:aramisc/domain/core/model/profile_edit_model/student_profile_edit_response_model.dart';
  ...
  void profilePhotoUpdate({required String file}) async {
    try {
      ...
      var request = http.MultipartRequest(
        'POST',
        Uri.parse(
          AramiscApi.studentProfilePhotoUpdate(
            studentId: globalRxVariableController.studentId.value!,
          ),
        ),
      );
