...
import 'package:aramisc/domain/core/model/book_list_response_model/book_list_response_model.dart';
import 'package:aramisc/domain/core/model/book_search_model/book_search_model.dart';
...
class BookListController extends GetxController {
  ...
  Future<BookSearchModel?> getSearchBook(String bookName) async {
    try {
      ...
      final response = await BaseClient().getData(
        url: AramiscApi.getBookSearch(bookName: bookName),
        header: GlobalVariable.header,
      );
