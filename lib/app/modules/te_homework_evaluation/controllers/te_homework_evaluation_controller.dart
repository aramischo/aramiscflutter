...
import 'package:aramisc/app/utilities/widgets/study_button/study_button.dart';
...
import 'package:aramisc/domain/core/model/teacher/teacher_homework_model/te_homework_evaluation_list_response_model.dart';
  ...
  Future<TeHomeworkEvaluationListResponseModel> getHomeworkEvaluationList(
    ...
    try {
      ...
      final response = await BaseClient().getData(
        url: AramiscApi.getTeacherHomeworkEvaluationList(
  ...
  Future<void> submitEvaluation({
    ...
    try {
      ...
      final response = await BaseClient().postData(
        url: AramiscApi.submitEvaluation,
        header: GlobalVariable.header,
        payload: {
