...
import 'package:aramisc/domain/core/model/admin/admin_individual_staff_details_response_model/admin_individual_staff_details_response_model.dart';
  ...
  Future getIndividualStaffData({required int staffIndividualId}) async {
    try {
      ...
      final response = await BaseClient().getData(
        url: AramiscApi.getAdminStaffIndividualData(
