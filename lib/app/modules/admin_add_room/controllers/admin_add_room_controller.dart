...
import 'package:aramisc/domain/core/model/admin/dormitory_model/dormitory_list_response_model.dart';
import 'package:aramisc/domain/core/model/admin/dormitory_model/dormitory_room_type_response_model.dart';
...
class AdminAddRoomController extends GetxController {
  ...
  Future<DormitoryListResponseModel> getDormitoryList() async {
    try {
      ...
      final response = await BaseClient().getData(
          url: AramiscApi.getAdminDormitoryList, header: GlobalVariable.header);
  ...
  Future<DormitoryRoomTypeResponseModel> getDormitoryRoomType() async {
    try {
      ...
      final response = await BaseClient().getData(
          url: AramiscApi.getAdminRoomType, header: GlobalVariable.header);
  ...
  void addDormitoryRoom() async {
    try {
      ...
      final response = await BaseClient().postData(
        url: AramiscApi.addDormitoryRoomFromAdin,
