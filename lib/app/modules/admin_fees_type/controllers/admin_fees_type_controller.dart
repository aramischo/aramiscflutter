...
import 'package:aramisc/app/modules/admin_fees_group/controllers/admin_fees_group_controller.dart';
...
import 'package:aramisc/domain/core/model/admin/admin_fees_model/admin_fees_type_response_model.dart';
import 'package:aramisc/domain/core/model/admin/admin_fees_model/fees_group_list_response_model.dart';
...
class AdminFeesTypeController extends GetxController {
  ...
  Future<AdminFeesTypeResponseModel> getFeesListList() async {
    try {
      ...
      final response = await BaseClient().getData(
          url: AramiscApi.getFeesTypeList, header: GlobalVariable.header);
  ...
  Future<void> deleteSingleFeesType(
    ...
    try {
      ...
      final response = await BaseClient().postData(
          url: AramiscApi.deleteFeesType(feesTypeId: feesTypeId),
          header: GlobalVariable.header);
  ...
  Future<void> updateSingleFeesType(
    ...
    try {
      ...
      final response = await BaseClient().postData(
        url: AramiscApi.updateSingleFeesType,
        header: GlobalVariable.header,
        payload: {
