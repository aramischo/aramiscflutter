...
import 'package:aramisc/domain/core/model/student_others_download_model/student_others_download_response_model.dart';
  ...
  void getStudentOthersDownloadList() async {
    try {
      ...
      final response = await BaseClient().getData(
        url: AramiscApi.getStudentOthersDownloadList(
