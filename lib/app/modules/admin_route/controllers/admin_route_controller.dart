...
import 'package:aramisc/domain/core/model/admin/admin_transport_model/admin_transport_route_response_model.dart';
...
class AdminRouteController extends GetxController {
  ...
  Future<AdminTransportRouteResponseModel> getAdminTransportRouteList() async {
    try {
      ...
      final response = await BaseClient().getData(
          url: AramiscApi.getAdminTransportRouteList,
  ...
  Future<AdminTransportRouteResponseModel> addTransportRoute() async {
    try {
      ...
      final response = await BaseClient().postData(
        url: AramiscApi.postAdminTransportRoute,
        header: GlobalVariable.header,
        payload: {
  ...
  Future<PostRequestResponseModel> deleteSingleRoute(
    ...
    try {
      ...
      final response = await BaseClient().postData(
          url: AramiscApi.deleteRoute(routeId: routeId),
          header: GlobalVariable.header);
  ...
  Future<void> updateRoute({
    ...
    try {
      ...
      final response = await BaseClient().postData(
        url: AramiscApi.postAdminRouteUpdate,
        header: GlobalVariable.header,
        payload: {
          "route_id": routeId,
          "title": routeTitleTextController.text,
