...
import 'package:aramisc/config/language/controller/language_selection.dart';
...
class SettingsController extends GetxController {
  ...
  Future<void> updateLanguage({required int langId}) async {
    try {
      ...
      final response =
          await http.post(Uri.parse(AramiscApi.updateLanguage(langId: langId)),
              body: jsonEncode(
                {
