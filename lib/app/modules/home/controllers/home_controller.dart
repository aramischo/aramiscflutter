...
import 'package:aramisc/app/data/module_data/home_data/home_dummy_data.dart';
...
import 'package:aramisc/domain/core/model/student_record/student_record_response_model.dart';
...
class HomeController extends GetxController {
  ...
  void getStudentRecord({required int studentId}) async {
    try {
      final response = await BaseClient().getData(
          url: AramiscApi.getStudentRecord(studentId: studentId),
          header: GlobalVariable.header);
  ...
  //         Uri.parse(AramiscApi.setToken(globalRxVariableController.userId.value.toString(), token)),
  //       headers: {
