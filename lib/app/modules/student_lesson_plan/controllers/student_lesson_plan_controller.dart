...
import 'package:aramisc/domain/core/model/student_lesson_plan_details_response_model/students_lesson_plan_details_response_model.dart';
import 'package:aramisc/domain/core/model/student_lesson_plan_response_model/student_lesson_plan_response_model.dart';
...
class StudentLessonPlanController extends GetxController {
  ...
  Future<StudentLessonPlanResponseModel?> getLessonPlanList({
    ...
    try {
      ...
      final response = await BaseClient().getData(
        url: AramiscApi.getStudentLessonPlan(
  ...
  Future<void> getLessonPlanListDetails(
    ...
    try {
      ...
      //isLoading.value = true;
      final response = await BaseClient().getData(
        url: AramiscApi.getStudentLessonPlanDetails(
