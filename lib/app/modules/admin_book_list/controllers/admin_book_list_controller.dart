...
import 'package:aramisc/domain/core/model/admin/admin_library_model/admin_book_list_response_model.dart';
    ...
    try {
      ...
      final response = await BaseClient().getData(
          url: globalRxVariableController.roleId.value == 4
              ? AramiscApi.getTeacherBookList
              : AramiscApi.getAdminBookList,
