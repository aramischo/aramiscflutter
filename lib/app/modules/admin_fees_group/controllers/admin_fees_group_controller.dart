...
class AdminFeesGroupController extends GetxController {
  ...
  Future<FeesGroupListResponseModel> getFeesGroupList() async {
    try {
      ...
      final response = await BaseClient().getData(
          url: AramiscApi.getFeesGroupList, header: GlobalVariable.header);
  ...
  Future<void> createFeesGroup() async {
    try {
      ...
      final response = await BaseClient().postData(
        url: AramiscApi.createFeesGroup,
  ...
  Future<void> deleteSingleFees(
    ...
    try {
      ...
      final response = await BaseClient().postData(
          url: AramiscApi.deleteSingleFeesGroup(feesId: feesId),
          header: GlobalVariable.header);
  ...
  Future<void> updateSingleFeesGroup(
    ...
    try {
      ...
      final response = await BaseClient().postData(
        url: AramiscApi.updateSingleFeesGroup,
        header: GlobalVariable.header,
        payload: {
          "id": feesId,
          "name": titleTextController.text,
