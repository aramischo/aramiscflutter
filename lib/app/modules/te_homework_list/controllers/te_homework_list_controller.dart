...
import 'package:aramisc/app/modules/te_add_homework/controllers/te_add_homework_controller.dart';
...
import 'package:aramisc/domain/core/model/teacher/teacher_homework_model/teacher_homework_list_response_model.dart';
...
class TeHomeworkListController extends GetxController {
  ...
  Future<TeacherHomeworkListResponseModel> getTeacherHomeWorkList() async {
    try {
      ...
      final response = await BaseClient().getData(
        url: AramiscApi.getTeacherHomeworkList,
  ...
  Future<TeacherHomeworkListResponseModel?> filterHomework({
    ...
    try {
      ...
      String baseUrl = AramiscApi.getTeacherHomeworkSearch(
        classId: classId,
        subjectId: subjectId,
      );
