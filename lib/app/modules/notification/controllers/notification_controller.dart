...
import 'package:aramisc/domain/core/model/default_response_model/default_response_model.dart';
import 'package:aramisc/domain/core/model/notification/notification_model.dart';
  ...
  void fetchNotifications() async {
    ...
    try {
      final res = await BaseClient().getData(
        url: AramiscApi.notificationList,
  ...
  void readAllNotifications() async {
    ...
    try {
      ...
      final response = await BaseClient().getData(
        url: AramiscApi.readAllNotification,
        header: GlobalVariable.header,
      );
