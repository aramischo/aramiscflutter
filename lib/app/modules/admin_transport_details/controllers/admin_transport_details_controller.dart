...
import 'package:aramisc/domain/core/model/admin/admin_transport_model/admin_transport_list_response_model.dart';
  ...
  Future<AdminTransportListResponseModel> getAdminTransportList() async {
    try {
      ...
      final response = await BaseClient().getData(
          url: AramiscApi.getAdminTransportList, header: GlobalVariable.header);
