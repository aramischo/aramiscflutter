...
import 'package:aramisc/domain/core/model/chat/auth_status_model/chat_auth_active_status_response_model.dart';
import 'package:aramisc/domain/core/model/chat/group_chat_user_list_response_model/group_chat_user_list_response_model.dart';
import 'package:aramisc/domain/core/model/chat/settings/chat_settings_model.dart';
...
class ChatController extends GetxController {
  ...
  Future<SingleChatUserListResponseModel?> getSingleChatList() async {
    ...
    try {
      ...
      final response = await BaseClient().getData(
        url: AramiscApi.getSingleChatUserList,
  ...
  Future<GroupChatUserListResponseModel?> getGroupChatList() async {
    ...
    try {
      ...
      final response = await BaseClient().getData(
        url: AramiscApi.getGroupChatUserList,
        header: GlobalVariable.header,
      );
  ...
  Future<void> changeStatus({
    ...
    try {
      ...
      final response = await BaseClient().postData(
          url: AramiscApi.changeActiveStatus(statusKey: statusKey),
          header: GlobalVariable.header);
  ...
  Future<ChatAuthActiveStatusResponseModel> getAuthActiveStatus() async {
    try {
      ...
      final response = await BaseClient()
          .getData(url: AramiscApi.chatStatus, header: GlobalVariable.header);
  ...
  Future<void> getChatSettings() async {
    try {
      var request = http.Request('GET', Uri.parse(AramiscApi.chatSetting));
