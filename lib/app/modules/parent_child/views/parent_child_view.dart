...
import 'package:aramisc/app/utilities/widgets/student_list_tile/student_list_tile.dart';
                        ...
                        ? ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              return StudentListTile(
                                ...
                                classSection: "${"Class".tr}: ${controller.parentChildList[index].className ?? "-"} | ${"Section".tr}: ${controller.parentChildList[index].section ?? "-"}",
