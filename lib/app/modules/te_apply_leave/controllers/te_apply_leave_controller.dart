...
import 'package:aramisc/domain/core/model/teacher/teacher_leave/teacher_leave_type_list_response_model.dart';
...
class TeApplyLeaveController extends GetxController {
  ...
  Future<TeacherLeaveTypeListResponseModel>
    ...
    try {
      ...
      final response = await BaseClient().getData(
        url: AramiscApi.getTeacherLeaveType,
  ...
  void applyLeave() async {
    try {
      debugPrint(AramiscApi.teacherApplyLeave);
      loadingController.isLoading = true;
      final request =
          http.MultipartRequest('POST', Uri.parse(AramiscApi.teacherApplyLeave));
