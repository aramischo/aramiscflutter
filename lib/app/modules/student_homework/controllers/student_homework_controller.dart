...
import 'package:aramisc/domain/core/model/student_homework_response_model/student_homework_model.dart';
...
class StudentHomeworkController extends GetxController {
  ...
  void getHomeWorkList() async {
    try {
      ...
      final response = await BaseClient().getData(
          url: AramiscApi.getStudentHomeWork(
  ...
  void pickFile() async {
    ...
    var tempFiles = await HelperFunctions.pickFiles();

    if (tempFiles != null && tempFiles.isNotEmpty) {
      pickedFileList.value = tempFiles.map((file) => File(file.path)).toList();
      pickedFileList.refresh();
    } else {
