...
import 'package:aramisc/app/modules/add_payment/views/widgets/text_field_with_tile.dart';
import 'package:aramisc/app/modules/fees/controllers/fees_controller.dart';
...
import 'package:aramisc/app/utilities/widgets/common_widgets/custom_divider.dart';
  ...
  Future<void> _makeAutoPayment() async {
    try {
      ...
      var request = http.MultipartRequest(
          'POST', Uri.parse(AramiscApi.studentFeesAddPaymentStore));
