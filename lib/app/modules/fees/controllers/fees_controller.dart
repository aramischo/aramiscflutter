...
import 'package:aramisc/app/modules/fees/views/widget/credit_card.dart';
import 'package:aramisc/app/modules/fees/views/widget/fees_tile.dart';
import 'package:aramisc/app/modules/home/controllers/home_controller.dart';
import 'package:aramisc/app/modules/student_wallet/controllers/student_wallet_controller.dart';
...
import 'package:aramisc/app/utilities/widgets/appbar/back_button_widget.dart';
...
import 'package:aramisc/domain/core/model/student_fees_response_model/fees_invoice_response_model/fees_invoice_details_response_model.dart';
import 'package:aramisc/domain/core/model/student_fees_response_model/fees_invoice_response_model/fees_invoice_response_model.dart';
import 'package:aramisc/domain/core/model/student_fees_response_model/student_fees_response_model.dart';
...
class FeesController extends GetxController {
  ...
  Future<StudentFeesInvoiceResponseModel?> getAllFeesList(
    ...
    try {
      ...
      final response = await BaseClient().getData(
        url: AramiscApi.getStudentFeesList(
  ...
  Future<FeesInvoiceResponseModel?> getFeesInvoice(
    ...
    try {
      ...
      banks.clear();
      final response = await BaseClient().getData(
        url: AramiscApi.getStudentFeesDetails(invoiceId: invoiceId),
        header: GlobalVariable.header,
      );
  ...
  Future<void> showInvoiceDetails({required int invoiceId}) async {
    ...
    try {
      final response = await BaseClient().getData(
          url: AramiscApi.getFeesInvoiceDetails(invoiceId: invoiceId),
          header: GlobalVariable.header);
