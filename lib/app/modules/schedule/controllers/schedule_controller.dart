...
import 'package:aramisc/domain/core/model/exam_dropdown_model/exam_dropdown_response_model.dart';
import 'package:aramisc/domain/core/model/student_exam_schedule/student_exam_schedule_model.dart';
...
class ScheduleController extends GetxController {
  ...
  void getStudentExamScheduleList(
    ...
    try {
      ...
      final response = await BaseClient().getData(
        url: AramiscApi.getStudentExamSchedule(examId, recordId),
  ...
  void getStudentExamList({required int recordId}) async {
    try {
      ...
      final response = await BaseClient().getData(
        url: AramiscApi.getStudentExamList(recordId),
        header: GlobalVariable.header,
      );
