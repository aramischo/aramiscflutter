...
import 'package:aramisc/app/style/bottom_sheet/bottom_sheet_shpe.dart';
...
import 'package:aramisc/app/utilities/widgets/common_widgets/duplicate_dropdown.dart';
import 'package:aramisc/app/utilities/widgets/common_widgets/primary_button.dart';
...
import 'package:aramisc/config/global_variable/payment/pay_stack_controller.dart';
import 'package:aramisc/config/global_variable/payment/paypal_controller.dart';
import 'package:aramisc/config/global_variable/payment/stripe_controller.dart';
import 'package:aramisc/domain/base_client/base_client.dart';
import 'package:aramisc/domain/core/model/student/wallet/bank_list/bank_list.dart';
import 'package:aramisc/domain/core/model/student/wallet/my_wallet/my_wallet.dart';
import 'package:aramisc/domain/core/model/student/wallet/payment_method_list/payment_method_list_response_model.dart';
...
class StudentWalletController extends GetxController {
  ...
  Future<MyWalletModel> getPaymentDetails() async {
    try {
      ...
      final response = await BaseClient()
          .getData(url: AramiscApi.getPaymentList, header: GlobalVariable.header);
  ...
  Future<PaymentMethodListResponseModel> getPaymentMethod() async {
    try {
      ...
      final response = await BaseClient().getData(
          url: AramiscApi.getPaymentMethodList, header: GlobalVariable.header);
  ...
  Future<PaymentMethodListResponseModel> getBankList() async {
    try {
      ...
      final response = await BaseClient()
          .getData(url: AramiscApi.getBankList, header: GlobalVariable.header);
  ...
  void pickFile() async {
    ...
    var teamFile = await HelperFunctions.pickFile();

    if (teamFile != null) {
      file.value = File(teamFile.path);
    } else {
  ...
  Future<void> _makeBankChequePayment() async {
    try {
      ...
      var request =
          http.MultipartRequest('POST', Uri.parse(AramiscApi.studentAddWallet));
