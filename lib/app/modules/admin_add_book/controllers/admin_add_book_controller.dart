...
import 'package:aramisc/domain/core/model/admin/admin_library_model/book_category_and_subject_list_response_model.dart';
  ...
  Future<BookCategoryAndSubjectListResponseModel>
    ...
    try {
      ...
      final response = await BaseClient().getData(
          url: AramiscApi.getAdminBookCategoryAndSubjectList,
  ...
  Future<void> addAdminBook(
    ...
    try {
      ...
      final response = await BaseClient().postData(
          url: AramiscApi.postAdminAddBook,
          header: GlobalVariable.header,
          payload: {
