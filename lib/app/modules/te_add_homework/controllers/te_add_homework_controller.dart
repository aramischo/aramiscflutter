...
import 'package:aramisc/app/utilities/datepicker_dialogue/date_picker.dart';
...
import 'package:aramisc/domain/core/model/teacher/teacher_homework_model/teacher_class_list_response_model.dart';
import 'package:aramisc/domain/core/model/teacher/teacher_homework_model/teacher_section_list_response_model.dart';
import 'package:aramisc/domain/core/model/teacher/teacher_homework_model/teacher_subject_list_response_model.dart';
...
class TeAddHomeworkController extends GetxController {
  ...
  Future<TeacherClassListResponseModel> getTeacherClassList() async {
    try {
      ...
      final response = await BaseClient().getData(
        url: AramiscApi.getTeacherAddHomeworkClassList,
  ...
  Future<TeacherSubjectListResponseModel> getTeacherSubjectList(
    ...
    try {
      ...
      final response = await BaseClient().getData(
        url: AramiscApi.getTeacherAddHomeworkSubjectList(classId: classId),
        header: GlobalVariable.header,
      );
  ...
  Future<TeacherSectionListResponseModel> getTeacherSectionList(
    ...
    try {
      ...
      final response = await BaseClient().getData(
        url: AramiscApi.getTeacherAddHomeworkSectionList(
          classId: classId,
          subjectId: subjectId,
        ),
        header: GlobalVariable.header,
  ...
  void pickFile() async {
    ...
    if (teamFile != null) {
      homeworkFile.value = File(teamFile.path);
    } else {
  ...
  Future<void> addTeacherHomework() async {
    try {
      ...
      final request =
          http.MultipartRequest('POST', Uri.parse(AramiscApi.teacherAddHomework));
