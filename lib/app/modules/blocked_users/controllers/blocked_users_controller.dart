...
import 'package:aramisc/domain/core/model/chat/blocked_users_list_response_model/blocked_users_list_response_model.dart';
  ...
  Future<BlockedUsersListResponseModel?> blockedUsersList() async {
    ...
    try {
      ...
      final response = await BaseClient().getData(
        url: AramiscApi.blockedChatUser,
  ...
  Future<void> blockSingleUser(
    ...
    try {
      ...
      final response = await BaseClient().postData(
          url: AramiscApi.blockSingleUser(type: type, userId: userId),
          header: GlobalVariable.header);
