...
class StudentSearchAttendanceController extends GetxController {
  ...
  Future<StudentAttendanceResponseModel?> getAttendanceList({
    ...
    try {
      ...
      final response = await BaseClient().getData(
        url: AramiscApi.getStudentAttendance(
  ...
  Future<StudentAttendanceResponseModel?> getAttendanceListWithDate({
    ...
    try {
      ...
      final response = await BaseClient().getData(
        url: AramiscApi.getStudentAttendanceWithDate(
          recordId: recordId,
          studentId: studentId,
          year: year,
          month: month,
  ...
  Future<StudentAttendanceResponseModel?> getSearchSubjectAttendanceList({
    ...
    try {
      final response = await BaseClient().getData(
        url: AramiscApi.getStudentSubjectSearchAttendance(
          recordId: recordId,
          studentId: studentId,
          subjectId: subjectId,
        ),
  ...
  Future<StudentAttendanceResponseModel?>
    ...
    try {
      ...
      final response = await BaseClient().getData(
        url: AramiscApi.getStudentSubjectSearchAttendanceWithDate(
          recordId: recordId,
          studentId: studentId,
          year: year,
          month: month,
