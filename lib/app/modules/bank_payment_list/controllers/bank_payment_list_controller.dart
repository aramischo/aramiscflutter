...
import 'package:aramisc/domain/core/model/admin/admin_fees_model/bank_payment_list_response_model.dart';
  ...
  Future<BankPaymentListResponseModel?> getAllBankPaymentList(
    ...
    try {
      ...
      final response = await BaseClient().getData(
        url: AramiscApi.getBankPaymentList(
            startDate: startDate,
            endDate: endDate,
            classId: classId,
            sectionId: sectionId),
  ...
  Future<void> bankPaymentStatusUpdate(
    ...
    try {
      ...
      final response = await BaseClient().postData(
        url: AramiscApi.getBankPaymentStatusUpdate,
        header: GlobalVariable.header,
        payload: {
