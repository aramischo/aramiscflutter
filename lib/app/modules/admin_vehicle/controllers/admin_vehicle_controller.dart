...
import 'package:aramisc/domain/core/model/admin/admin_transport_model/admin_vehicle_driver_response_model.dart';
import 'package:aramisc/domain/core/model/admin/admin_transport_model/admin_vehicle_list_response_model.dart';
...
class AdminVehicleController extends GetxController {
  ...
  Future<AdminVehicleListResponseModel> getAdminVehicleList() async {
    try {
      ...
      final response = await BaseClient().getData(
          url: AramiscApi.getAdminVehicleList, header: GlobalVariable.header);
  ...
  Future<AdminVehicleDriverResponseModel> getAdminVehicleDriverList() async {
    try {
      ...
      final response = await BaseClient().getData(
          url: AramiscApi.getAdminDriverList, header: GlobalVariable.header);
  ...
  Future<AdminVehicleListResponseModel> addAdminVehicle() async {
    try {
      ...
      final response = await BaseClient().postData(
          url: AramiscApi.adminAddVehicle,
