...
import 'package:aramisc/domain/core/model/admin/admin_attendance_model/admin_student_search_atten_response_model.dart';
...
class AdminClassAttendanceIndividualDetailsController extends GetxController {
    ...
    try {
      ...
      final response = await BaseClient().getData(
        url: globalRxVariableController.roleId.value == 1
            ? AramiscApi.getAdminStudentSearchDetailsList(
                studentAttendanceId: studentAttendanceId)
            : AramiscApi.getTeacherStudentSearchDetailsList(
                studentAttendanceId: studentAttendanceId),
  ...
  Future<AdminStudentSearchAttenResponseModel?>
    ...
    try {
      ...
      final response = await BaseClient().getData(
        url: globalRxVariableController.roleId.value == 1
            ? AramiscApi.getAdminStudentSearchDetailsListWithDate(
                studentAttendanceId: studentAttendanceId,
                month: month,
                year: year)
            : AramiscApi.getTeacherStudentSearchDetailsListWithDate(
                studentAttendanceId: studentAttendanceId,
                month: month,
                year: year),
        header: GlobalVariable.header,
