...
import 'package:aramisc/app/utilities/widgets/bottom_sheet_tile/bottom_sheet_tile.dart';
import 'package:aramisc/app/utilities/widgets/common_widgets/primary_button.dart';
import 'package:aramisc/app/utilities/widgets/custom_radio_button/custom_radio_button.dart';
...
import 'package:aramisc/domain/core/model/admin/admin_leave_model/admin_approve_leave_response_model.dart';
import 'package:aramisc/domain/core/model/admin/admin_leave_model/admin_pending_leave_response_model.dart';
import 'package:aramisc/domain/core/model/admin/admin_leave_model/admin_rejected_leave_response_model.dart';
...
class AdminLeaveController extends GetxController {
  ...
  Future<AdminPendingLeaveResponseModel?> getAdminPendingLeave() async {
    ...
    try {
      ...
      final response = await BaseClient().getData(
        url: AramiscApi.getAdminPendingLeaveList,
  ...
  Future<AdminApproveLeaveResponseModel?> getAdminApproveLeave(
    ...
    try {
      ...
      final response = await BaseClient().getData(
        url: AramiscApi.getAdminApproveLeaveList,
        header: GlobalVariable.header,
      );
  ...
  Future<AdminRejectedLeaveResponseModel?> getAdminRejectedLeave(
    ...
    try {
      ...
      final response = await BaseClient().getData(
        url: AramiscApi.getAdminRejectedLeaveList,
        header: GlobalVariable.header,
      );
  ...
  void updateLeaveStatus(
    ...
    try {
      ...
      final res = await BaseClient().postData(
        url: AramiscApi.adminLeaveStatusUpdate(
