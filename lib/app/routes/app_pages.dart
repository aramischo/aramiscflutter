...
import '../modules/timeline_page/bindings/timeline_page_binding.dart';
import '../modules/timeline_page/views/timeline_page_view.dart';
...
class AppPages {
  ...
  static final routes = [
    ...
    GetPage(
      name: _Paths.TIMELINE_PAGE,
      page: () => const TimelinePageView(),
