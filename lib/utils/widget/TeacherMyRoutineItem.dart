...
// import 'package:aramisc/utils/model/TeacherMyRoutine.dart';
...
//     // print(AramiscApi.getTeacherMyRoutine(id));
//     final response = await http.get(Uri.parse(AramiscApi.getTeacherMyRoutine(id)),headers: Utils.setHeader(_token.toString()));
//     // print(response.body);
