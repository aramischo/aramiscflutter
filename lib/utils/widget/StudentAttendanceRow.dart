...
import 'package:aramisc/screens/teacher/attendance/attendance_controller.dart';
...
import 'package:aramisc/utils/model/Attendance.dart';
...
//  }
  Future<bool> checkAttendance() async {
    ...
    final response = await http.get(
        Uri.parse(AramiscApi.attendanceCheck(
          date ?? '',
          mClass,
          mSection,
        )),
