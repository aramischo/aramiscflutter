...
import 'package:aramisc/utils/model/zoom_meeting.dart';
import 'package:aramisc/utils/permission_check.dart';
import 'package:aramisc/webview/launch_webview.dart';
              ...
              children: <Widget>[
                ...
                Expanded(
                  child: OutlinedButton(
                      ...
                      onPressed: () async {
                        final _url = AramiscApi.getJoinMeetingUrlApp(
                            mid: zoomMeeting.meetingId);

                        debugPrint('App URL: ${AramiscApi.getJoinMeetingUrlApp(mid: zoomMeeting.meetingId)}');
                        debugPrint('Web URL: ${AramiscApi.getJoinMeetingUrlWeb(mid: zoomMeeting.meetingId)}');
                        ...
                        if (await canLaunch(_url)) {
                          ...
                          Navigator.push(
                              ...
                              ScaleRoute(
                                  page: LaunchWebView(
                                      launchUrl: AramiscApi.getJoinMeetingUrlWeb(
