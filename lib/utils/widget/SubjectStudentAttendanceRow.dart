...
import 'package:aramisc/screens/teacher/attendance/subject_attendance_controller.dart';

// Project imports:
import 'package:aramisc/utils/Utils.dart';
import 'package:aramisc/utils/apis/Apis.dart';
import 'package:aramisc/utils/custom_widgets/CustomRadioButton/CustomButton/ButtonTextStyle.dart';
import 'package:aramisc/utils/custom_widgets/CustomRadioButton/custom_radio_button.dart';
import 'package:aramisc/utils/model/SubjectAttendance.dart';
import 'package:aramisc/utils/model/GlobalClass.dart';
  ...
  Widget build(BuildContext context) {
    ...
    final String image =
        attendanceStudents.photo == null || attendanceStudents.photo == ''
            ...
            : AramiscApi.root + '${attendanceStudents.photo}';
    return Column(
      children: <Widget>[
        ListTile(
...
//    final response = await http.get(AramiscApi.attendance_defalut_send(date, mClass, mSection));
...
//  }
  Future<bool> checkAttendance() async {
    ...
    final response = await http.get(
        Uri.parse(
            AramiscApi.subjectattendanceCheck(date, mClass, mSection, mSubject)),
