...
import 'package:aramisc/utils/value_checker/value_checker.dart';
...
class User {
  ...
  factory User.fromJson(Map<String, dynamic> json) => User(
        ...
        admissionNo: ValueChecker.checkInt(json["admission_no"]),
        rollNo: ValueChecker.checkInt(json["roll_no"]),
        ...
        age: ValueChecker.checkInt(json["age"]),
        height: json["height"] ?? "",
        weight: json["weight"] ?? "",
        ...
        bloodgroupId: ValueChecker.checkInt(json["bloodgroup_id"]),
        religionId: ValueChecker.checkInt(json["religion_id"]),
        ...
        parentId: ValueChecker.checkInt(json["parent_id"]),
        userId: ValueChecker.checkInt(json["user_id"]),
        roleId: ValueChecker.checkInt(json["role_id"]),
        genderId: ValueChecker.checkInt(json["gender_id"]),
...
class Parents {
  ...
  factory Parents.fromJson(Map<String, dynamic> json) => Parents(
        ...
        parentUser: json["parent_user"] == null
            ? null
            : ParentUser.fromJson(json["parent_user"]),
      );
