...
// Project imports:
import 'ButtonTextStyle.dart';
import 'CustomListViewSpacing.dart';
  ...
  CustomRadioButton({Key? key, 
    ...
    this.wrapAlignment = WrapAlignment.start,
        ...
        assert(buttonValues?.toSet().length == buttonValues?.length,
            "Multiple buttons with same value cannot exist"), super(key: key);
...
class _CustomRadioButtonState extends State<CustomRadioButton> {
  ...
  List<Padding>? _buildButtonsColumn() {
    return widget.buttonValues?.map((e) {
      ...
      return Padding(
        ...
        child: Card(
          ...
          color: _currentSelectedLabel == widget.buttonLables?[index ?? 0]
          ...
          child: Container(
            ...
            child: MaterialButton(
              ...
              onPressed: () {
                ...
                setState(() {
                  _currentSelectedLabel = widget.buttonLables?[index ?? 0];
                });
              },
              child: Center(
                child: Text(
                  widget.buttonLables?[index ?? 0] ?? '',
