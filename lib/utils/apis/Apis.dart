...
class AramiscApi {
  ...
  static String login(String email, String password) {
    ...
    String encodedPassword = Uri.encodeQueryComponent(password);
    return baseApi +
        'login?email=' +
        encodedEmail +
        '&password=' +
  ...
  static String readMyAllNotifications(dynamic userID) {
  ...
  static String adminFeeList = baseApi + "sm-fees-group";

  static String adminFeesTypeList = baseApi + "fees-type";

  static String adminFeesGroupUpdate = baseApi + "sm-fees-group-update";
  static String adminFeesGroupStore = baseApi + "fees-group-store";
  static String adminFeesGroupDelete = baseApi + "sm-fees-group-delete";
