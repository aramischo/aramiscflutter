...
class Data {
  ...
  ProfilePersonalPermissions? showPermission;

  Data({this.profilePersonal, this.showPermission});

  Data.fromJson(Map<String, dynamic> json) {
    profilePersonal = json['profilePersonal'] != null ? ProfilePersonal.fromJson(json['profilePersonal']) : null;
    showPermission = json['show_permission'] != null ? ProfilePersonalPermissions.fromJson(json['show_permission']) : null;
  }
...
class ProfilePersonalPermissions {
  int? session;
  int? studentClass;
  int? section;
  int? rollNumber;
