...
import 'package:aramisc/utils/model/AdminBookCategory.dart';
import 'package:aramisc/utils/model/AdminBookSubject.dart';
...
class _AddAdminBookState extends State<AddAdminBook> {
  ...
  Future<AdminSubjectList> getAllSubject() async {
    final response = await http.get(Uri.parse(AramiscApi.subjectList),
  ...
  Future<AdminCategoryList> getAllCategory() async {
    final response = await http.get(Uri.parse(AramiscApi.bookCategory),
        headers: Utils.setHeader(_token.toString()));
