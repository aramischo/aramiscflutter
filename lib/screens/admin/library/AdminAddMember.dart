...
import 'package:aramisc/utils/model/LibraryCategoryMember.dart';
import 'package:aramisc/utils/model/Section.dart';
import 'package:aramisc/utils/model/Staff.dart';
import 'package:aramisc/utils/model/Student.dart';
...
class _AddMemberState extends State<AddMember> {
  ...
  Future<LibraryMemberList> getAllCategory() async {
    final response = await http.get(
        Uri.parse(AramiscApi.getLibraryMemberCategory),
  ...
  Future<SectionList> getAllSection(dynamic id, dynamic classId) async {
    final response = await http.get(
        Uri.parse(AramiscApi.getSectionById(
          id,
          classId,
        )),
        headers: Utils.setHeader(_token.toString()));
  ...
  Future getAllClass(dynamic id) async {
    final response = await http.get(
        Uri.parse(AramiscApi.getClassById(
          id,
        )),
        headers: Utils.setHeader(_token.toString()));
  ...
  Future<StudentList> getAllStudent() async {
    final response = await http.get(
        Uri.parse(AramiscApi.getStudentByClassAndSection(
          selectedClassId,
          selectedSectionId,
        )),
        headers: Utils.setHeader(_token.toString()));
  ...
  Future<StaffList> getAllStaff(dynamic staffId) async {
    final response = await http.get(
        Uri.parse(AramiscApi.getAllStaff(
          staffId,
        )),
        headers: Utils.setHeader(_token.toString()));
