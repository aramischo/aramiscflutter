...
import 'package:aramisc/utils/model/Notice.dart';
import 'package:aramisc/utils/widget/NoticeRow.dart';
...
class _StaffNoticeScreenState extends State<StaffNoticeScreen> {
  ...
  Future<NoticeList> getNotices(dynamic id) async {
    ...
    final response = await http.get(Uri.parse(AramiscApi.notice(_schoolId)),
