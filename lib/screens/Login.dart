...
import 'package:aramisc/utils/server/LoginService.dart';
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<String> getEmail(String user) async {
    final response = await http.get(Uri.parse(AramiscApi.getEmail));
    debugPrint(AramiscApi.getEmail);
    debugPrint(response.body);
    var jsonData = json.decode(response.body);

    //print(AramiscApi.getDemoEmail(schoolId));
