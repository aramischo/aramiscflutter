...
import 'package:aramisc/screens/chat/models/ChatGroupPusher.dart';
import 'package:aramisc/screens/chat/models/ChatMessage.dart';
...
class PusherController extends GetxController {
  ...
  dynamic onAuthorizer(
    ...
    var result = await http.post(
      Uri.parse(AramiscApi.chatBroadCastAuth),
      headers: {
