...
import 'package:aramisc/screens/chat/views/BlockedUserPage.dart';
import 'package:aramisc/screens/chat/views/Single/ChatOpenPage.dart';
import 'package:aramisc/screens/chat/views/ChatPeopleSearchPage.dart';
import 'package:aramisc/screens/chat/views/Group/CreateGroupPage.dart';
import 'package:aramisc/screens/chat/views/Group/GroupChatOpenPage.dart';
...
import 'package:aramisc/utils/remove_html_tag.dart';
                      ...
                      return ListTile(
                        onTap: () {
                          ...
                          Get.to(
                            () => ChatOpenPage(
                                ...
                                onlineStatus:
                                    chatUser.activeStatus.runtimeType == int
                        ...
                        subtitle: Text(
                          chatUser.lastMessage != null
                              ? "${HtmlUtils.removeAllHtmlTags(chatUser.lastMessage ?? '<p>...</p>').characters.take(20)} ..."
                              : "",
