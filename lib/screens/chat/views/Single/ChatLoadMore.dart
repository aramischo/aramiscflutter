...
import 'package:aramisc/screens/chat/controller/chat_open_controller.dart';
...
import 'package:aramisc/screens/chat/models/ChatMessageOpenModel.dart';
...
class ChatLoadMore extends LoadingMoreBase<ChatMessage> {
  ...
  Future deleteSingleMessage(ChatMessage chatMessage) async {
    ...
    try {
      ...
      final response = await _dio.post(
        AramiscApi.chatSingleMsgDelete,
        options: Options(
          headers: Utils.setHeader(chatOpenController.token.toString()),
        ),
        data: jsonEncode(jsonData),
