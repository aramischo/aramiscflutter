...
import 'package:aramisc/utils/model/TeacherSubject.dart';
import 'package:aramisc/utils/permission_check.dart';
import 'package:aramisc/utils/widget/image_pick_dialog.dart';
...
class _AddHomeworkScrrenState extends State<AddHomeworkScrren> {
  ...
  Future<TeacherSubjectList> getAllSubject(int id) async {
    ...
    try{
      final response = await http.get(Uri.parse(AramiscApi.getTeacherSubject(id)),
          headers: Utils.setHeader(_token.toString()));
      if (response.statusCode == 200) {
        var jsonData = jsonDecode(response.body);
  ...
  void sentNotificationToSection(dynamic classCode, dynamic sectionCode) async {
    final response = await http.get(Uri.parse(
        AramiscApi.sentNotificationToSection('Homework',
