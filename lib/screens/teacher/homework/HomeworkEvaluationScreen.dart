...
// Project imports:
import 'package:aramisc/screens/teacher/homework/EvaluateScreen.dart';
import 'package:aramisc/screens/teacher/homework/UploadedFilesView.dart';
...
import 'package:aramisc/utils/model/HomeworkEvaluation.dart';
import 'package:aramisc/utils/widget/HomeWorkEvaluationDetailsRow.dart';
...
class _HomeworkEvaluationScreenState extends State<HomeworkEvaluationScreen> {
  ...
  Future<StudentEvaluationList> fetchEvaluationList(
    ...
    // print(AramiscApi.homeworkEvaluationList(classId, sectionId, homeworkId));
    final response = await http.get(
        Uri.parse(
            AramiscApi.homeworkEvaluationList(classId, sectionId, homeworkId)),
