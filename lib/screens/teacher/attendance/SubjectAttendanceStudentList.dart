...
import 'package:aramisc/utils/widget/SubjectStudentAttendanceRow.dart';
...
class _SubjectStudentListAttendanceState
  ...
  Future<SubjectAttendanceList> getAttendance() async {
    final response = await http.get(
        Uri.parse(AramiscApi.subjectattendanceCheck(
  ...
  Future setDefaultAttendance(Map data) async {
    ...
    try {
      final response = await http.post(
          Uri.parse(AramiscApi.subjectattendanceDefaultSent),
          headers: Utils.setHeader(token ?? ''),
