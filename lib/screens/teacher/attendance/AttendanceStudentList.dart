...
import 'package:aramisc/utils/widget/ShimmerListWidget.dart';
import 'package:aramisc/utils/widget/StudentAttendanceRow.dart';
...
class _StudentListAttendanceState extends State<StudentListAttendance> {
  ...
  void sentNotificationToSection() async {
    final response = await http.get(Uri.parse(
        AramiscApi.sentNotificationToSection('Attendance', 'Attendance sunmitted',
  ...
  Future setDefaultAttendance(Map data) async {
    ...
    final response = await http.post(Uri.parse(AramiscApi.attendanceDefaultSent),
