...
import 'package:aramisc/utils/model/LeaveType.dart';
...
class _ApplyLeaveScreenState extends State<ApplyLeaveScreen> {
  ...
  Future<LeaveList> getAllLeaveType(id) async {
    final response = await http.get(Uri.parse(AramiscApi.userLeaveType(_id)),
  ...
  void uploadLeave() async {
    ...
    response = await dio.post(
      AramiscApi.userApplyLeaveStore,
      data: formData,
      options: Options(
        headers: {
  ...
  void addLeaveData() async {
    response = await dio.get(AramiscApi.sendLeaveData(
        applyDate ?? '',
        '$leaveId',
        fromDate ?? '',
        toDate ?? '',
