...
class Plan {
    ...
    factory Plan.fromJson(Map<String, dynamic> json) => Plan(
        ...
        lessonId: int.tryParse(json["lesson_id"]),
        topicId: json["topic_id"],
        lessonDetailId: int.tryParse(json["lesson_detail_id"]),
        topicDetailId: int.tryParse(json["topic_detail_id"]),
        ...
        roomId: json["room_id"],
        teacherId: int.tryParse(json["teacher_id"]),
        classPeriodId: json["class_period_id"],
        subjectId: int.tryParse(json["subject_id"]),
        ...
        routineId: int.tryParse(json["routine_id"]),
...
class Topic {
    ...
    factory Topic.fromJson(Map<String, dynamic> json) => Topic(
        ...
        topicId: int.tryParse(json["topic_id"]),
        lessonPlannerId: int.tryParse(json["lesson_planner_id"]),
        createdAt: DateTime.parse(json["created_at"]),
        updatedAt: DateTime.parse(json["updated_at"]),
