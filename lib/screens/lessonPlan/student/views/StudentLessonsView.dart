...
import 'package:aramisc/screens/lessonPlan/student/model/LessonPlan.dart';
import 'package:aramisc/screens/lessonPlan/student/model/LessonPlanDetails.dart';
...
class _StudentLessonsViewState extends State<StudentLessonsView> {
  ...
  Future<LessonPlan> getLessonPlan(int recordId, studentId) async {
    try {
      final response = await http.get(
        Uri.parse(AramiscApi.studentLessonPlan + "/${widget.id}/$recordId"),
  ...
  Future<List<PlanDetails>> getLessonByDay(
    ...
    try {
      final response = await http.get(
        Uri.parse(AramiscApi.studentLessonPlanByDate +
  ...
  Future<LessonPlan> getPreviousWeek(int recordId, studentId, startDate) async {
    try {
      final response = await http.get(
        Uri.parse(AramiscApi.studentLessonPreviousWeek +
  ...
  Future<LessonPlan> getNextWeek(int recordId, studentId, endDate) async {
    try {
      final response = await http.get(
        Uri.parse(AramiscApi.studentLessonNextWeek +
