...
import 'package:aramisc/utils/model/ActiveOnlineExam.dart';
import 'package:aramisc/utils/model/StudentRecord.dart';
import 'package:aramisc/utils/widget/ActiveOnlineExam.dart';
...
class _ActiveOnlineExamScreenState extends State<ActiveOnlineExamScreen> {
  ...
  Future<ActiveExamList> getAllActiveExam(var id, int recordId) async {
    final response = await http.get(
        Uri.parse(AramiscApi.getStudentOnlineActiveExam(id, recordId)),
