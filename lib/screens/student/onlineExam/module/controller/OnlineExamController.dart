...
import 'package:aramisc/screens/student/onlineExam/module/controller/ExamController.dart';
import 'package:aramisc/screens/student/onlineExam/module/model/TakeExamModel.dart';
  ...
  Future finalSubmit() async {
    ...
    try {
      ...
      final response = await http.post(
        Uri.parse(AramiscApi.studentSubmitAnswerFinal),
    ...
    try {
      ...
      final response = await http.post(
        Uri.parse(isMultiple
            ? AramiscApi.studentSubmitAnswerMulti
            : AramiscApi.studentSubmitAnswerSubjective),
        headers: Utils.setHeader(userController.token.toString()),
        body: jsonEncode(data),
      );
      print(response.body);
  ...
  Future startQuiz(examId, recordId, String schoolId) async {
    try {
      ...
      final response = await http.get(
          Uri.parse(AramiscApi.takeOnlineExamModule(
