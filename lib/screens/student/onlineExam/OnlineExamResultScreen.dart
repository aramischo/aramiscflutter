...
import 'package:aramisc/utils/model/ONlineExamResult.dart';
import 'package:aramisc/utils/model/StudentRecord.dart';
import 'package:aramisc/utils/widget/OnlineExamResultRow.dart';
...
class _OnlineExamResultScreenState extends State<OnlineExamResultScreen> {
  ...
  Future<OnlineExamResultList> getAllOnlineExamResult(
    ...
    final response = await http.get(
        Uri.parse(
            AramiscApi.getStudentOnlineActiveExamResult(id, code, recordId)),
  ...
  Future<OnlineExamNameList> getAllOnlineExam(var id, int recordId) async {
    final response = await http.get(
        Uri.parse(AramiscApi.getStudentOnlineActiveExamName(id, recordId)),
        headers: Utils.setHeader(_token.toString()));
