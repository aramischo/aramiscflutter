...
import 'package:aramisc/utils/model/Book.dart';
import 'package:aramisc/utils/widget/BookRowLayout.dart';
...
class _BookListState extends State<BookListScreen> {
  ...
  Future<BookList> getAllBooks() async {
    final response = await http.get(Uri.parse(AramiscApi.bookList),
