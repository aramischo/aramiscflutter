...
import 'package:aramisc/utils/model/StudentAttendance.dart';
...
class _StudentAttendanceScreenState extends State<StudentAttendanceScreen> {
  ...
  Future<StudentDetailsModel> getProfile(id) async {
    final response = await http.get(
        Uri.parse(AramiscApi.getChildren(id.toString())),
  ...
  Future<StudentAttendanceList> getAllStudentAttendance(dynamic id,
    ...
    final response = await http.get(
        Uri.parse(
            AramiscApi.getStudentAttendence(widget.id, recordId, month, year)),
