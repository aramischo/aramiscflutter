...
import 'package:aramisc/utils/file_download_utils.dart';
import 'package:aramisc/utils/model/StudentDetailsModel.dart';
...
import 'package:aramisc/utils/server/ProfileService.dart';
import 'package:aramisc/utils/widget/ProfileListRow.dart';
...
class _ProfileState extends State<Profile> {
  ...
  Future<StudentDetailsModel> getProfile(id) async {
    final response = await http.get(Uri.parse(AramiscApi.getChildren(id)),
                          ...
                          Container(
                            ...
                            child: CircleAvatar(
                              ...
                              child: CachedNetworkImage(
                                imageUrl:
                                    "${AramiscApi.root}/${_studentDetails.studentData?.user?.studentPhoto}",
                ...
                child: CircleAvatar(
                  ...
                  child: CachedNetworkImage(
                    imageUrl: _studentDetails
                        ...
                        : "${AramiscApi.root}/${_studentDetails.studentData?.user?.parents?.fathersPhoto}",
                ...
                child: CircleAvatar(
                  ...
                  child: CachedNetworkImage(
                    imageUrl: _studentDetails
                        ...
                        : "${AramiscApi.root}/${_studentDetails.studentData?.user?.parents?.mothersPhoto}",
                    imageBuilder: (context, imageProvider) => Container(
                      decoration: BoxDecoration(
                        image: DecorationImage(
                          image: imageProvider,
  ...
  String buildGuardianPhoto(Parents parents) {
    if (parents.relation == 'Father') {
      if (parents.fathersPhoto == null || parents.fathersPhoto == '') {
        return AramiscApi.root + 'public/uploads/staff/demo/staff.jpg';
      } else {
        return "${AramiscApi.root}/${parents.fathersPhoto}";
      }
    } else if (parents.relation == 'Mother') {
      if (parents.mothersPhoto == null || parents.mothersPhoto == '') {
        return AramiscApi.root + 'public/uploads/staff/demo/staff.jpg';
      } else {
        return "${AramiscApi.root}/${parents.mothersPhoto}";
      }
    } else {
      if (parents.guardiansPhoto == null || parents.guardiansPhoto == '') {
        return AramiscApi.root + 'public/uploads/staff/demo/staff.jpg';
      } else {
        return "${AramiscApi.root}/${parents.guardiansPhoto}";
      }
    }
  }
    ...
    return Container(
      ...
      child: ListView(
        ...
        children: [
          ProfileRowList(
            "Height".tr,
            _studentDetails.studentData?.user?.height != null
                ? _studentDetails.studentData!.user!.height.toString()
                : '',
          ),
          ProfileRowList(
            "Weight".tr,
            _studentDetails.studentData?.user?.weight != null
...
bool isNullOrEmpty(Object? o) => o == null || (o is String && o.isEmpty);
