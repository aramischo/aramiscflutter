...
import 'package:aramisc/utils/model/Dormitory.dart';
import 'package:aramisc/utils/widget/Dormitory_row.dart';
...
class _DormitoryScreenState extends State<DormitoryScreen> {
  ...
  Future<DormitoryList> getAllDormitory() async {
    final response = await http.get(Uri.parse(AramiscApi.studentDormitoryList),
