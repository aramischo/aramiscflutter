...
import 'package:aramisc/utils/model/Transport.dart';
import 'package:aramisc/utils/widget/TransportRow.dart';
...
class _TransportState extends State<TransportScreen> {
  ...
  Future<TransportList> getAllTransport() async {
    final response = await http.get(Uri.parse(AramiscApi.studentTransportList),
