...
import 'package:aramisc/utils/model/Teacher.dart';
import 'package:aramisc/utils/widget/Student_teacher_row_layout.dart';
...
class _StudentTeacherState extends State<StudentTeacher>
  ...
  Future<TeacherList> getAllTeacher(dynamic id, int recordId) async {
    final response = await http.get(
        Uri.parse(AramiscApi.getStudentTeacherUrl(
