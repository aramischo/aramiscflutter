...
import 'package:aramisc/utils/model/Timeline.dart';
import 'package:aramisc/utils/widget/TimeLineView.dart';
...
class _TimelineScreenState extends State<TimelineScreen> {
  ...
  Future<TimelineList> getAllTimeline(dynamic id) async {
    final response = await http.get(Uri.parse(AramiscApi.getStudentTimeline(id)),
