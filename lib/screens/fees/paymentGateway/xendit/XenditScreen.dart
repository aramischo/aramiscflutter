...
import 'package:aramisc/screens/fees/paymentGateway/xendit/XenditPaymentScreen.dart';
...
import 'package:aramisc/utils/model/XenditErrorResponse.dart';
...
class XenditScreenState extends State<XenditScreen> {
  ...
  Future xenditCreditCardToken(fullDate) async {
    setState(() {
      loading = true;
      loadingText = "Processing Payment, Don't close this page. Please wait...";
    });
    try {
      Map data = {
        "is_single_use": true,
                ...
                content: SizedBox(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      return Text(
                          xenditErrorResponse.errors?[index].message ?? '');
                    },
                  ),
                ),
                actions: <Widget>[
