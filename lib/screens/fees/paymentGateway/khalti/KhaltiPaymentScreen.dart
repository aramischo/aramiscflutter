...
import 'package:aramisc/screens/fees/paymentGateway/khalti/KhaltiPayment.dart';
...
class KhaltiPaymentService {
  ...
  Future paymentCallBack({dynamic reference, dynamic status}) async {
    ...
    final response = await http.post(
      Uri.parse(AramiscApi.paymentSuccessCallback(status, reference, amount)),
      headers: {
        "Accept": "application/json",
        "Authorization": token.toString(),
      },
  ...
  Future studentPayment() async {
    ...
    try {
      final response = await http.get(
          Uri.parse(AramiscApi.studentFeePayment(id.toString(),
