...
import 'package:aramisc/screens/fees/model/FeesGroup.dart';
import 'package:aramisc/screens/fees/model/FeesType.dart';
...
class _FeesTypeScreenState extends State<FeesTypeScreen> {
  ...
  Future<FeeTypeList> getFeesTypes() async {
    final response = await http.get(Uri.parse(AramiscApi.adminFeesTypeList),
  ...
  Future<FeeGroupList> getFeesGroups() async {
    final response = await http.get(Uri.parse(AramiscApi.adminFeeList),
        headers: Utils.setHeader(_token.toString()));
                        ...
                        IconButton(
                          onPressed: () async {
                            final response = await http.post(
                              Uri.parse(AramiscApi.adminFeesTypeDelete),
                          ...
                          children: <Widget>[
                            ...
                            Container(
                              ...
                              child: ElevatedButton(
                                ...
                                onPressed: () async {
                                  final response = await http.post(
                                    Uri.parse(AramiscApi.adminFeesTypeStore),
                                    headers: Utils.setHeader(_token),
                                    body: jsonEncode({
                        ...
                        children: <Widget>[
                          ...
                          Container(
                            ...
                            child: ElevatedButton(
                              ...
                              onPressed: () async {
                                final response = await http.post(
                                  Uri.parse(AramiscApi.adminFeesTypeUpdate),
                                  headers: Utils.setHeader(_token),
                                  body: jsonEncode({
                                    'name': titleController?.text,
                                    'description': descripController?.text,
