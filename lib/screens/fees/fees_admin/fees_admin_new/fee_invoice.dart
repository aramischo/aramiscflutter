...
import 'package:aramisc/screens/fees/fees_admin/fees_admin_new/fee_transactions_view.dart';
import 'package:aramisc/screens/fees/fees_admin/fees_admin_new/fees_invoice_view.dart';
...
import 'package:aramisc/utils/widget/custom_search_delegate.dart';
...
class _FeesInvoiceScreenState extends State<FeesInvoiceScreen> {
  ...
  Future<FeesRecordList> getFeesInvoice() async {
    final response = await http.get(Uri.parse(AramiscApi.adminFeesInvoiceList),
        headers: Utils.setHeader(_token.toString()));

    log("jsonData ::: ${response.body}");
                                  ...
                                  onSelected: (String value) async {
                                    if (value == 'view') {
                                      ...
                                      final response = await http.post(
                                        Uri.parse(
                                            AramiscApi.adminFeesInvoiceDelete),
