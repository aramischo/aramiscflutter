...
class FeePaymentReportModel {
    ...
    factory FeePaymentReportModel.fromJson(Map<dynamic, dynamic> json){


            return FeePaymentReportModel(
                paymentReport: List<PaymentReport>.from(
                    json["paymentReport"].map((x) => PaymentReport.fromJson(x))),
